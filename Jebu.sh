...
echo $i" |"$cy"     BLACK MAFIA TERMUX ASSOCIATE"$i"         |"
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" Malik Najeeb [FR13ND8]"$i"          |"
echo $i" |"$pu" FACEBOOK :"$ku" Malik Najeeb "$i"                   |"
echo $i" |"$pu" THANKS TO :"$cy"~ [ABU BAKR ABDULLAH] [MR.jebu] [MR.Hack3r]"$i"  |"
echo $i" |"$cy"            ~ [Najeeb] [%Jebu%] [Malik.456]"$i" |"
echo $i" |"$pu" Contack WhatsApp :"$ku" +923035308892"$i"             |"
echo $i" |"$pu" Contack Gmail :"$ku" itznajeeb418@gmail.com"$i"      |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
